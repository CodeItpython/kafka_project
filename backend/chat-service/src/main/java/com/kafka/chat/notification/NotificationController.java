...
public class NotificationController {
    ...
    @GetMapping
    public ResponseEntity<NotificationListResponse> notifications(@AuthenticationPrincipal AuthUser user) {
        return ResponseEntity.ok(notificationService.notifications(user));
    }

    @GetMapping("/subscription")
    public ResponseEntity<NotificationSubscriptionResponse> subscription(@AuthenticationPrincipal AuthUser user) {
    ...
    public ResponseEntity<NotificationListResponse> markAllRead(@AuthenticationPrincipal AuthUser user) {
