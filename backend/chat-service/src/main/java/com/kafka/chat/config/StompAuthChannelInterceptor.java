...
import com.kafka.chat.service.ChatRoomAccessService;
import com.kafka.chat.security.JwtService;
...
public class StompAuthChannelInterceptor implements ChannelInterceptor {
    ...
    private String authenticate(StompHeaderAccessor accessor) {
        ...
        try {
            // A valid signature is proof the user authenticated with auth-service,
            // so chat-service trusts the token without a user-table lookup.
